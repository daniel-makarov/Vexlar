...
function NewsletterForm() {
  ...
  return (
    <div className="flex flex-col space-y-8 md:w-[500px] items-center">
      <form
        onSubmit={handleSubmit}
        className="newsletter-form mt-10 animate-fade-in-3 items-center"
      >
      <div className="flex flex-col space-y-8 md:w-[400px] items-center">
        <h1 style={{
          color: '#bdbbb9',  // A softer shade of white
          fontSize: '18px',  // Larger font size for better visibility
          fontFamily: 'Arial, sans-serif',  // A clean, professional font family
          textShadow: '0px 2px 4px rgba(0,0,0,0.5)'  // Subtle text shadow for depth
        }}>
          Join the waitlist
        </h1>
      </div>
